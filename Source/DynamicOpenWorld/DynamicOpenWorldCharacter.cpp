...
ADynamicOpenWorldCharacter::ADynamicOpenWorldCharacter()
{
...
void ADynamicOpenWorldCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ADynamicOpenWorldCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ADynamicOpenWorldCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ADynamicOpenWorldCharacter::Look);
	}
	else
	{
...
void ADynamicOpenWorldCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ADynamicOpenWorldCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
